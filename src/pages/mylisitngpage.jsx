...
const MyListings = () => {
  ...
  const [visibleListings, setVisibleListings] = useState(5); // Track the number of visible listings
      ...
      {myListings.length > visibleListings && (
        <div className="w-full text-center">
          <button
            ...
            className="mt-[40px] bg-[#e4c1f9] w-[220px] sm:w-[370px] h-[60px] sm:h-[90px] rounded-[60px] font-normal text-lg sm:text-2xl border-b-4 border-gray-400 mb-[60px]"
          >
            View More Listings...
          </button>
        </div>
